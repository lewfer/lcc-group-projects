...
function setup() {
  ...
  maxY = max(table.getColumn(columns['s1']))
...
function LineChart(data) {
  xCount = data.getRowCount()
  xBandWidth = width/xCount

  // Get the column of values
  let values = data.getColumn("s1")

  let prevX,prevY
    
  for (var r = 0; r < rowCount; r++) {
    var yVal = parseInt(values[r],10);
