 ...
 */
 ...
 function draw() {
   ...
   drawCircle(build[currentFrame].month, build[currentFrame].china, "blue")
   drawCircle(build[currentFrame].month, build[currentFrame].usa, color(0,255,0, 10))
 ...
 function drawCircle(month, size, colour) {
   ...
   var month = month + random(-0.45,0.45) // Math.round(random(0,numMonths-1),0) + random(-0.5,0.5)
   var angle = month*PI*2/12
   var distance = random(150,400)
